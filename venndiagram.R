...
overlap_list <- list("TCGA-HNSC" = tcga, "NOROC" = noroc, "KO cs WT HSC3" = ko)
overlap_plot <- venndetail(overlap_list) #identify overlapping terms
overlap_df <- result(overlap_plot)

fwrite(overlap_df, "2025_03_06_overlap_tcga_noroc_KO.csv", row.names = TRUE)


x = list(tcga,noroc, ko)
...
ggexport(plot, filename = "2025_03_06_tcga_noroc_KO_venndiagram_myc_targets.png",res=200,width = 2500, height = 2000)
ggexport(plot, filename = "2025_03_06_tcga_noroc_KO_venndiagram_myc_targets.pdf",width = 15, height = 15)
